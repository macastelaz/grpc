...
typedef grpc_call_credentials*(*grpc_service_account_jwt_access_credentials_create_with_regional_access_boundary_type)(const char* json_key, gpr_timespec token_lifetime, const char* regional_access_boundary, void* reserved);
extern grpc_service_account_jwt_access_credentials_create_with_regional_access_boundary_type grpc_service_account_jwt_access_credentials_create_with_regional_access_boundary_import;
#define grpc_service_account_jwt_access_credentials_create_with_regional_access_boundary grpc_service_account_jwt_access_credentials_create_with_regional_access_boundary_import
...
typedef grpc_call_credentials*(*grpc_external_account_credentials_create_with_regional_access_boundary_type)(const char* json_string, const char* scopes_string, const char* regional_access_boundary);
extern grpc_external_account_credentials_create_with_regional_access_boundary_type grpc_external_account_credentials_create_with_regional_access_boundary_import;
#define grpc_external_account_credentials_create_with_regional_access_boundary grpc_external_account_credentials_create_with_regional_access_boundary_import
...
typedef grpc_call_credentials*(*grpc_google_compute_engine_credentials_create_with_regional_access_boundary_type)(grpc_google_compute_engine_credentials_options* options, const char* regional_access_boundary);
extern grpc_google_compute_engine_credentials_create_with_regional_access_boundary_type grpc_google_compute_engine_credentials_create_with_regional_access_boundary_import;
#define grpc_google_compute_engine_credentials_create_with_regional_access_boundary grpc_google_compute_engine_credentials_create_with_regional_access_boundary_import
