...
typedef grpc_call_credentials*(*grpc_service_account_jwt_access_credentials_create_with_encoded_locations_type)(const char* json_key, gpr_timespec token_lifetime, const char* encoded_locations, void* reserved);
extern grpc_service_account_jwt_access_credentials_create_with_encoded_locations_type grpc_service_account_jwt_access_credentials_create_with_encoded_locations_import;
#define grpc_service_account_jwt_access_credentials_create_with_encoded_locations grpc_service_account_jwt_access_credentials_create_with_encoded_locations_import
...
typedef grpc_call_credentials*(*grpc_external_account_credentials_create_with_encoded_locations_type)(const char* json_string, const char* scopes_string, const char* encoded_locations);
extern grpc_external_account_credentials_create_with_encoded_locations_type grpc_external_account_credentials_create_with_encoded_locations_import;
#define grpc_external_account_credentials_create_with_encoded_locations grpc_external_account_credentials_create_with_encoded_locations_import
