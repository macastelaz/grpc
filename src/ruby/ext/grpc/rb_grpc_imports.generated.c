...
grpc_service_account_jwt_access_credentials_create_with_encoded_locations_type grpc_service_account_jwt_access_credentials_create_with_encoded_locations_import;
grpc_external_account_credentials_create_type grpc_external_account_credentials_create_import;
grpc_external_account_credentials_create_with_encoded_locations_type grpc_external_account_credentials_create_with_encoded_locations_import;
...
void grpc_rb_load_imports(HMODULE library) {
  ...
  grpc_service_account_jwt_access_credentials_create_with_encoded_locations_import = (grpc_service_account_jwt_access_credentials_create_with_encoded_locations_type) GetProcAddress(library, "grpc_service_account_jwt_access_credentials_create_with_encoded_locations");
  ...
  grpc_external_account_credentials_create_with_encoded_locations_import = (grpc_external_account_credentials_create_with_encoded_locations_type) GetProcAddress(library, "grpc_external_account_credentials_create_with_encoded_locations");
