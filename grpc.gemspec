...
Gem::Specification.new do |s|
  ...
  s.files += %w( include/grpc++/impl/codegen/config_protobuf.h )
  ...
  s.files += %w( include/grpcpp/generic/callback_generic_service.h )
  s.files += %w( include/grpcpp/generic/generic_stub.h )
  s.files += %w( include/grpcpp/generic/generic_stub_callback.h )
  ...
  s.files += %w( include/grpcpp/impl/codegen/config_protobuf.h )
  ...
  s.files += %w( include/grpcpp/impl/generic_stub_internal.h )
  ...
  s.files += %w( include/grpcpp/ports_def.inc )
  s.files += %w( include/grpcpp/ports_undef.inc )
  ...
  s.files += %w( src/core/credentials/call/regional_access_boundary_util.cc )
  s.files += %w( src/core/credentials/call/regional_access_boundary_util.h )
